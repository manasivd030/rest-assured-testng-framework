...
public class CRUDTests extends BaseTest {
    ...
    public void crudTest(String firstName, String lastName, Boolean depositPaid,
        ...
        var createBookingPayload = ApiRequestHelper.getCreateBookingRequest(firstName, lastName, totalPrice,
        ...
        System.out.print("After retrieveing bookingid"+totalPrice);
    ...
    private void validateRetrievedBookingDataFromGetApi(String firstName, String lastName, Boolean depositPaid,
                                                        String additionalNeeds, int totalPrice, String checkInDate,
        ...
        System.out.println("Inside validate retrieve booking method"+totalPrice);
    }
}
